...
<body>
                ...
                <fieldset>
                  <p>Obtaining GCJ-02/BD-09 coordinates from maps</p>

                  <div class="api">
                    <form target="_blank" action="https://lbs.amap.com/demo/javascript-api/example/geocoder/regeocoding">
                      <input type="submit" class="button" value="Open Amap API" />
                      <br />
                    </form>
                  </div>
                  <div class="api">
                    <form target="_blank" action="https://api.map.baidu.com/lbsapi/getpoint/index.html">
                      <input type="submit" class="button" value="Open Baidu API" />
                      <br />
                    </form>
                  </div>
                  <div class="api">
                    <form target="_blank" action="https://lbs.qq.com/getPoint/">
                      <input type="submit" class="button" value="Open QQ Maps API" />
                      <br />
                    </form>
                  </div>
                </fieldset>
                ...
                <form onsubmit="ClearAll">
                  <input type="submit" class="button" value="Clear All" style="margin: 2rem;"/><br />
                </form>
                ...
                <p><b>Select coordinate system of origin</b></p>
                    ...
                    <div class="radio">
                      ...
                      <input type="radio" onclick="javascript:selectW();" name="cosys" id="WGS" value ="WGS" checked="checked"/><label for="WGS">WGS-84 (GPS)</label>
                    </div>
                    ...
                    <div>
                      ...
                      <form onsubmit="doSplit(this.Split.value); return false;">
                        <input type="text" id="Split" size="36" placeholder="Coordinates" />
                  ...
                  <footer>
                    ...
                    <p><i class="fab fa-github"></i>View code and license <a target="_blank" href="https://github.com/marksnoeck">here</a>.</p>
